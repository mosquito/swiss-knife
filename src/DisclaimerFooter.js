    ...
    >
      <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
        ...
        <a
          ...
          className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium rounded shadow-sm transition-all hover:shadow-md focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 whitespace-nowrap"
