    ...
    <div className="tool-container">
      <div className="tool-content">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded shadow-sm divide-y divide-gray-200 dark:divide-gray-700">
            <button onClick={()=>setShowKeys(!showKeys)} className="w-full flex items-center justify-between px-3 py-2 text-xs font-bold bg-gray-50 dark:bg-gray-700">
              <span>Keys</span>
            ...
            <div className="flex flex-wrap items-center gap-2 text-xs">
                <label className="flex items-center gap-1">Alg:
                  <UndoableSelect value={rsaAlg} onChange={e=>setRsaAlg(e.target.value)} className="px-2 py-1 rounded bg-gray-200 dark:bg-gray-700">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded shadow-sm p-3 space-y-3">
            <div className="flex flex-wrap gap-2 text-xs items-center">
              <label className="flex items-center gap-1">Mode:
                <UndoableSelect value={aesMode} onChange={e=>setAesMode(e.target.value)} className="px-2 py-1 rounded bg-gray-200 dark:bg-gray-700">
                  <option value="encrypt">Encrypt</option>
                  <option value="decrypt">Decrypt</option>
                </UndoableSelect>
              </label>
              <UndoableInput type="text" value={aesPass} onChange={e=>setAesPass(e.target.value)} placeholder="Passphrase" className="px-2 py-1 rounded bg-gray-200 dark:bg-gray-700 text-xs" />
